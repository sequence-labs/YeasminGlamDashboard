...
export const defaultTemplateClauses = {
  ...
  schedule:
    "The service windows below are for scheduling and coordination. Contracted services, quantities, and fees are listed in the Pricing section. Artist is not responsible for the actual start time of any ceremony, reception, cocktail hour, photo session, or other event activity. Artist sets the arrival and start time as needed to meet the completion target. Client is responsible for ensuring all recipients are present, prepared, and ready at the agreed start time. The order and pacing of services are at Artist's discretion.",
  pricing:
  ...
  limitations:
    "All people receiving services must be present, ready, and prepared at their scheduled time. Artist may set or revise the order of services to protect the overall timeline. If someone is late, unavailable, unprepared, has wet hair, has makeup already applied, has lash extensions that were supposed to be removed, or otherwise causes delay, Artist may shorten, modify, or skip that service to stay on schedule. No refund, credit, or price reduction will be given for services shortened, modified, skipped, refused, or discontinued due to late arrival, lack of preparation, client delay, guest delay, venue delay, room access issues, safety concerns, or schedule changes outside Artist's control. Artist guarantees the booked services will be made available within the scheduled service window; any service not received because a recipient was late, unprepared, extended their own service, requested upgrades, or was otherwise unavailable when reached is forfeited, and no refund, credit, or reduction is owed. Each service is allotted an approximate working window based on the booked look, and more detailed or upgraded looks require additional time; when a recipient's service runs beyond its window, that time comes from the overall schedule and any service not reached is forfeited, and no refund, credit, or reduction is owed. Any request to add, upgrade, or change a service during the event is handled under this Agreement; Artist is not required to pause an in-progress service to renegotiate scope, pricing, or timing, and continuing a requested service does not waive any term of this Agreement.",
  cancellation:
  ...
  general:
    "Artist may take and use photos or videos of completed services for portfolio, website, advertising, or social media only if Client gives written consent. Client may decline without affecting services. This Agreement is governed by New York law. The parties will try to resolve disputes informally first. Any changes must be in writing; changes to fees, refunds, credits, or services are valid only if confirmed in writing by Artist, and all other changes are confirmed by both parties. Electronic signatures are valid. This Agreement is the full agreement between the parties and replaces prior messages, quotes, or discussions. Services will be performed in accordance with applicable health, sanitation, legal, and venue requirements disclosed to Artist in advance. The parties agree to raise any concerns about the services directly with the other party and allow a reasonable opportunity to resolve them before posting public statements or reviews; this does not prevent either party from sharing an honest experience and asks only for a good-faith attempt to resolve privately first.",
  signatures:
