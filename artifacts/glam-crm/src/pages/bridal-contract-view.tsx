    ...
    <div className="bg-white min-h-screen text-black text-[14px]">
      ...
      <div className="contract-print-page max-w-[820px] mx-auto px-10 py-10 print:px-8 print:py-6 font-sans">
        ...
        <div className="text-center mb-8 pb-6 border-b-2 border-black">
          <h1 className="text-2xl font-bold text-black tracking-tight uppercase mb-1">Bridal Makeup &amp; Hair Service Agreement</h1>
        ...
        <Section number="5" title="Service Scope">
          ...
          <p className="text-sm text-gray-700 mb-2">
            ...
            extra coverage), Artist may, at Artist's sole discretion, decline the request, perform it as time
            allows, or charge the applicable add-on rate as listed in Artist's services. Accommodating any such
            request does not extend the scheduled completion time, and no refund, credit, or price reduction will
            be given for any booked service that is shortened or skipped because added or upgraded work consumed
            the available time.
          </p>
        ...
        <Section number="7" title="Timeline, Late Clients, Safety, and Conduct">
          ...
          <p className="text-sm text-gray-700 mb-2">
            ...
            service not reached as a result is forfeited, and no refund, credit, or reduction is owed. Artist
            determines time allocation using professional judgment to complete as many booked services as possible.
          </p>
          <p className="text-sm text-gray-700 mb-2">
